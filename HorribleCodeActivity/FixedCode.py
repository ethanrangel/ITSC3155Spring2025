...
def main():
    ...
    while answer != "off":
        ...
        desiredInput = input("What operation do you want to do with this calculator add, subtract, multiply, divide or off: ").lower()
        ...
        if desiredInput == "off":
            ...
            number1 = float(input("what is the first number you want to perform the operation on"))
            number2 = float(input("what is the second number you want to perform the operation on"))
